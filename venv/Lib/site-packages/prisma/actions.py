...
class UserActions(Generic[_PrismaModelT]):
    ...
    async def find_first_or_raise(
        ...
        -------
        ```py
        # find the second User record ordered by the is_admin field
...
class ProductActions(Generic[_PrismaModelT]):
    ...
    async def find_first(
        ...
        -------
        ```py
        # find the second Product record ordered by the original_price field
    ...
    async def find_first_or_raise(
        ...
        -------
        ```py
        # find the second Product record ordered by the new_price field
    ...
    async def update_many(
        ...
        total = await Product.prisma().update_many(
            data={
                'expairy_date': datetime.datetime.utcnow()
            },
            where={}
        )
        ```
    ...
    async def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group Product records by category_id values
        # and count how many records are in each group
